...
description: >-
  Track the latest updates, improvements, and bug fixes in Warstellar's
  releases.
---
## Recent Updates

Stay informed about Warstellar's evolution. Yogdf sgdf gdfg dfg fu receive new features that enhance AI-powered coding assistance, performance improvements for faster workflows, and critical bug fixes. Check the details below for each release.
...
<Steps>
  <Step title="Update SDK" icon="download" title-type="p">
  ...
  <Step title="Regenerate Tokens" icon="key" title-type="p">
    Visit `https://dashboard.warstellar.com/settings/tokens` and create new JWT tokens.
  </Step>

  <Step title="Update Code" icon="code" title-type="p">
...
<Columns cols="3">
  <Card title="Q4 2024" href="#" icon="rocket" horizontal="false">
    Multimodal AI support for images and diagrams in code gen.
  </Card>

  <Card title="Q1 2025" href="#" icon="zap" horizontal="false">
    On-device inference for privacy-focused coding.
  </Card>

  <Card title="Q2 2025" href="#" icon="shield" horizontal="false">
